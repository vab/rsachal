...
int test_attack_88(void)
{
	...
	L[2] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-88 Challenge Full Test Client\n");
        printf("\n");
...
int attack_88(void)
{
	...
	L[2] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-88 Challenge Full Attack Client\n");
        printf("\n");

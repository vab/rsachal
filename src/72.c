...
int test_attack_72(void)
{
	...
	L[2] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-72 Challenge Full Test Client\n");
        printf("\n");
...
int attack_72(void)
{
	...
	L[2] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-72 Challenge Full Attack Client\n");
        printf("\n");

...
int test_attack_64(void)
{
	...
	int rslt = 0;
        ...
        printf("CryptNET:  RSA Labs RC5-64 Challenge Full Test Client\n");
        printf("\n");
...
int attack_64(void)
{
	...
	int rslt = 0;
        ...
        printf("CryptNET:  RSA Labs RC5-64 Challenge Full Attack Client\n");
        printf("\n");

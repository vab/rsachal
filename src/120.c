...
int test_attack_120(void)
{
	...
	L[3] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-120 Challenge Full Test Client\n");
        printf("\n");
...
int attack_120(void)
{
	...
	L[3] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-120 Challenge Full Attack Client\n");
        printf("\n");

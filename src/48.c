...
int test_attack_48(void)
{
	...
	int rslt = 0;
        ...
        printf("CryptNET:  RSA Labs RC5-48 Challenge Full Test Client\n");
        printf("\n");
...
int attack_48(void)
{
	...
	int rslt = 0;
        ...
        printf("CryptNET:  RSA Labs RC5-48 Challenge Full Attack Client\n");
        printf("\n");

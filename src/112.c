...
int test_attack_112(void)
{
	...
	L[3] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-112 Challenge Full Test Client\n");
        printf("\n");
...
int attack_112(void)
{
	...
	L[3] = 0x00000000;
        ...
        printf("CryptNET:  RSA Labs RC5-112 Challenge Full Attack Client\n");
        printf("\n");
